...
def parse_args_and_config():
    parser = argparse.ArgumentParser(description='Training NightDrop with Patch-Based Denoising Diffusion Models')
    ...
    parser.add_argument("--test_set", type=str, default='RDiffusion',
                        help="restoration test set results: ['RDiffusion', 'IDT', 'restormer', 'Uformer', 'onego', 'atgan']")
